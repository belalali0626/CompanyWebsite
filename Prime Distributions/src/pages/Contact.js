...
const Contact = () => {
    useDocTitle('Prime Distribution - Contact Us')
    ...
    const sendEmail = (e) => {
        ...
        // Generate a random delay between 3 to 7 seconds
        const delay = Math.random() * (7000 - 3000) + 3000; // 3000 ms = 3 s, 7000 ms = 7 s
        ...
        setTimeout(() => {
            ...
            .finally(() => {
                ...
                Notiflix.Notify.success('Email Submitted. You should receive a response within 3-5 working days.', {
                    timeout: 6000,
                    clickToClose: true,
                });
            });
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">124 City Road, London, EC1V 2NX</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">info@primedistribution.com</p>
                            </div>
